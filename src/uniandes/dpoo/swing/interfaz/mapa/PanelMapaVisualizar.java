    ...
    public void paint( Graphics g )
    {
        ...
        if (restaurantes != null) {
            for (Restaurante restaurante : restaurantes) {
                // Dibuja cada restaurante en el mapa
                int x = restaurante.getX(); // Obtener coordenada X del restaurante
                int y = restaurante.getY(); // Obtener coordenada Y del restaurante

                // Dibujar un punto o círculo en el mapa para el restaurante
                g2d.setColor(Color.RED);
                g2d.fillOval(x - 5, y - 5, 10, 10); // Círculo rojo centrado en (x, y)

                // Dibujar el nombre del restaurante al lado del punto
